...
<link rel="stylesheet" type="text/css" href="/go/Public/css/notice.css" />
</head>
<body>
	<!-- top -->
	<!-- top -->
...
<!-- top结束 -->
<div id="center">	
	<div id="biao"> <?php echo ($result["title"]); ?> </div>     
        <div id="content">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($result["content"]); ?>  </div>     
	<div id="time"> <?php echo (date("y-m-d h:i:s",$result["time"])); ?>  </div>     
