...
<!-- top结束 -->
	<div class='main'>
		<div id='left'>
			...
			<ul class='left-list'>
                           <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li class='list-l1'>
					<div class='list-l1-wrap'>
						<h4><a href="/go/index.php/Home/List/index/cid/<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></a></h4>
						<ul class='list-l2'>
                                                     <?php $__FOR_START_20584__=0;$__FOR_END_20584__=3;for($i=$__FOR_START_20584__;$i < $__FOR_END_20584__;$i+=1){ ?><li><a href="/go/index.php/Home/List/index/cid/<?php echo ($v['child'][$i]['id']); ?>"><?php echo ($v['child'][$i]['name']); ?></a></li><?php } ?>
						</ul>
					</div>

					<div class='list-more hidden'>
						<ul>
                                                     <?php $__FOR_START_7297__=3;$__FOR_END_7297__=count($v['child']);for($i=$__FOR_START_7297__;$i < $__FOR_END_7297__;$i+=1){ ?><li><a href="/go/index.php/Home/List/index/cid/<?php echo ($v['child'][$i]['id']); ?>"><?php echo ($v['child'][$i]['name']); ?></a></li><?php } ?>
						</ul>
					</div>
				</li><?php endforeach; endif; else: echo "" ;endif; ?>
		...
		<div id='center'>
			<div id='animate'>
				<div class='imgs-wrap'>
					<ul>
						<li>
							<a href=""><img src="/go/Public/Images/1.jpg" width='558' height='190'/></a>
						</li>
						<li>
							<a href=""><img src="/go/Public/Images/2.jpg" width='558' height='190'/></a>
						</li>
						<li>
							<a href=""><img src="/go/Public/Images/3.jpg" width='558' height='190'/></a>
						</li>
					</ul>
				</div>
				<ul class='ani-btn'>
					<li class='ani-btn-cur'>校园得声<i></i></li>
					<li>得声祝你成功<i></i></li>
					<li style='border:none'>有实力做得声<i></i></li>
				</ul>
			</div>
			...
			<dl class='answer-list'>
				<dt>
					...
					<a href='/go/index.php/Home/List/index/cid/0'>更多>></a>
				</dt>
                              <?php if(is_array($unask)): $i = 0; $__LIST__ = $unask;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><dd>
					<a href="/go/index.php/Home/Question/index/qid/<?php echo ($v["id"]); ?>"><?php echo ($v["content"]); ?></a>
			...
			<dl class='answer-list'>
				<dt>
					...
					<a href='/go/index.php/Home/List/index/cid/0'>更多>></a>
                                ...
                                <?php if(is_array($gaoask)): $i = 0; $__LIST__ = $gaoask;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><dd>
					<a href="/go/index.php/Home/Question/index/qid/<?php echo ($v["id"]); ?>"><b><?php echo ($v["reward"]); ?></b><?php echo ($v["content"]); ?></a>
					<span><?php echo ($v["answer"]); ?>回答</span>
				</dd><?php endforeach; endif; else: echo "" ;endif; ?>
