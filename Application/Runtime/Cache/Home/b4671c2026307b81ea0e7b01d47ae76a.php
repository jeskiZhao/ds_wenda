...
<head>
    ...
    <link href="/go/Public/css/robot.css" rel="stylesheet" type="text/css">
     <script type="text/javascript">
         var controller="/go/index.php/Home/Robot";
     </script>
    <script type="text/javascript" src='/go/Public/js/robot.js'></script>
</head>
<body>
    <!-- top -->
	<div id='top-fixed'>
...
<!-- top结束 --> 
    <div class="container">
        ...
        <div class="left">
            <div id="jiao">
            <div class="biaoti">小问聊天</div>
            <div id="result">
             
            </div>
            <div class="shuru">
                <input name="text" id="text" type="text">
                <input value="发送" id="btn"  type="button">
            </div>
            </div>
           <div class="zuoxia">
             <p>关键字<p>
