...
<link rel="stylesheet" type="text/css" href="/go/Public/css/hall.css" />
</head>
<body>
	<!-- top -->
	<!-- top -->
...
<div id="center">
	      ...
	      <div class="right" name="neirong">
		   <div class="hangyi">
                       <?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="hangyi1"><a href="/go/index.php/Home/Shop/thing/gid/<?php echo ($v["id"]); ?>"><img src="<?php echo ($v["pic"]); ?>" /><p><?php echo ($v["simintroduce"]); ?></p></a></div><?php endforeach; endif; else: echo "" ;endif; ?>
		   </div>
                  <div class="page">
                      <?php echo ($page); ?>
                  </div>
